        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    ...
                    <button type="button" onclick="window.location.href='index.php?controller=ControllerBatch&action=insert'" class="btn btn-block btn-success">Cadastrar</button>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    <table id="datatable" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Win 95</td>
                                <td>
                                    <a href="index.php?controller=ControllerBatch&action=edit&id=<?php ?>" class="btn btn-primary">Editar</a>
                                    <a href="index.php?controller=ControllerBatch&action=delete&id=<?php ?>" class="btn btn-danger">Excluir</a>
                                </td>
                            </tr>
                        </tbody>
                        <tfoot>
